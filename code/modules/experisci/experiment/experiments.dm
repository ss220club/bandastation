...
/datum/experiment/ordnance/gaseous/plasma
	...
	description = "Доставка плазмы район проведения операции может оказаться полезной. Упакуйте указанный газ в канистру и взорвите его с помощью компрессора для канистр. Опубликуйте данные в отчёте."
	gain = list(10,40)
	target_amount = list(200,600)
	experiment_proper = TRUE
...
/datum/experiment/scanning/people/augmented_organs
	...
	description = "Нам нужно собрать данные о том, как кибернетические жизненно важные органы сочетаются с биологией человека. Проведите сканирование человека с такими имплантатами, чтобы понять их совместимость."
	performance_hint = "Проведите хирургическую операцию по манипуляции органами, чтобы заменить один из жизненно важных органов на кибернетическую альтернативу."
...
/datum/experiment/scanning/points/bluespace_crystal
	...
	description = "Исследуйте свойства блуспейс кристаллов путём сканирования искусственные или естественные варианты. Это поможет нам глубже понять феномен блуспейса."
	required_points = 1
	required_atoms = list(
...
/datum/experiment/scanning/points/anomalies
	...
	description = "Теперь у нас есть возможность справиться с аномалиями. Нейтрализуйте их с помощью нейтрализатора аномалий или зарядите необработанные ядра на refinery и просканируйте результаты."
	required_points = 4
...
/datum/experiment/scanning/points/machinery_tiered_scan/tier2_any
	...
	description = "Наши новые детали машин нуждаются в практических испытаниях, чтобы получить подсказки о возможных дальнейших усовершенствованиях, а также общее подтверждение того, что мы действительно не разработали худшие детали. Просканируйте любую машину с улучшенными деталями и сообщите о результатах."
	required_points = 6
	required_atoms = list(
		/obj/machinery = 1
	)
...
/datum/experiment/scanning/points/machinery_tiered_scan/tier3_any
	...
	description = "Наши новые детали машин нуждаются в практических испытаниях, чтобы получить подсказки о возможных дальнейших усовершенствованиях, а также общее подтверждение того, что мы действительно не разработали худшие детали. Просканируйте любую машину с продвинутыми деталями и сообщите о результатах."
	required_points = 6
	required_atoms = list(
		/obj/machinery = 1
	)
