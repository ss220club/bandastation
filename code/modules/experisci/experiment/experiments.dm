...
/datum/experiment/ordnance/explosive/lowyieldbomb
	...
	description = "Маломощные взрывчатые вещества могут оказаться полезными для наших групп по защите активов. Зафиксируйте небольшой взрыв с помощью доплеровской решетки и опубликуйте данные в отчёте."
	gain = list(10,15,20)
...
/datum/experiment/ordnance/explosive/highyieldbomb
	...
	description =  "Некоторые реакции протекают очень энергично и могут быть использованы для создания более мощных взрывчатых веществ. Зафиксируйте взрыв любого резервуара с помощью доплеровской решетки и опубликуйте данные в отчёте. Допускается любая газовая реакция."
	gain = list(10,50,100)
...
/datum/experiment/ordnance/explosive/hydrogenbomb
	...
	description = "Горение водорода и его производных может быть очень мощным. Зафиксируйте любой взрыв резервуара с помощью доплеровской решетки и опубликуйте данные в отчёте. Разрешены только водородные или тритиевые взрывы."
	gain = list(15,40,60)
...
/datum/experiment/ordnance/explosive/nobliumbomb
	...
	description = "Гиперноблиум образуется очень энергично, и его можно использовать для изготовления взрывчатых веществ. Зафиксируйте любой взрыв бака с помощью доплеровской решетки и опубликуйте данные в отчёте. Разрешена только конденсация гиперноблия."
	gain = list(15,60,120)
	target_amount = list(50,100,300)
	experiment_proper = TRUE
	sanitized_misc = TRUE
...
/datum/experiment/ordnance/explosive/pressurebomb
	...
	description = "Газы с высокой удельной теплоемкостью могут нагревать газы с низкой и создавать большое давление. Зафиксируйте взрыв любого резервуара с помощью доплеровской решетки и опубликуйте данные в отчёте. Никаких газовых реакций не допускается."
	gain = list(10,50,100)
...
/datum/experiment/ordnance/gaseous/nitrous_oxide
	...
	description = "Доставка N2O в район проведения операции может оказаться полезной. Упакуйте указанный газ в резервуар и взорвите его с помощью компрессора для резервуаров. Опубликуйте данные в отчёте."
	gain = list(10,40)
...
/datum/experiment/scanning/random/mecha_equipped_scan
	name = "Материалы для Мехов 2: Испытание на нагрузку"
	description = "Экзокостюмы создают уникальную нагрузку на конструкцию транспортного средства. Сканируйте экзокостюмы, собранные на вашем предприятии по мехосборке и полностью оснащенные, чтобы ускорить моделирование структурных нагрузок."
	possible_types = list(/obj/vehicle/sealed/mecha)
	total_requirement = 2
