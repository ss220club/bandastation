...
/obj/item/paper/guides/jobs/atmos/hypertorus
	...
	default_raw_text = "<B>Как безопасно(TM) работать с Термоядерным реактором</B><BR>\
	...
	Усильте ваше охлаждение, поместите внутрь замедлителя газы с высокой теплоёмкостью (гипер-ноблиум поможет справиться с этой проблемой)<BR><BR>\
	...
	-Из термоядерной смеси нельзя удалить газы, за исключением гелия и анти-ноблиума.<BR>\
	-Гипер-ноблиум значительно уменьшит мощность вашей смеси.<BR>\
	-Анти-ноблиум значительно УВЕЛИЧИТ мощность вашей смеси.<BR>\
