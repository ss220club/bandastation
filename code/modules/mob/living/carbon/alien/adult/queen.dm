...
/mob/living/carbon/alien/adult/royal/queen/Initialize(mapload)
	...
	for(var/mob/living/carbon/alien/adult/royal/queen/Q in GLOB.carbon_list)
		...
		if(Q.client)
			...
			ru_names_rename(ru_names_list("alien princess ([number])", "принцесса Чужих ([number])", "принцессы Чужих ([number])", "принцессе Чужих ([number])", "принцессу Чужих ([number])", "принцессой Чужих ([number])", "принцессе Чужих ([number])", gender = FEMALE))
