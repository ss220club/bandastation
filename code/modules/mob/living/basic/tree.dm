/mob/living/basic/tree
	name = "\proper сосна"
	desc = "Разозленный древоподобное существо. Кажется, оно не любит праздники..."
	...
	response_help_simple = "поглаживает"
	...
	death_message = "разрублена на части!"
