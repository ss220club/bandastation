/obj/machinery/vending/magivend
	...
	product_ads = "FJKLFJSD;AJKFLBJAKL;1234, ПСИХИ, ХАХАХА!;>ТО ЧУВСТВО, КОГДА...;Завалите этих ебанашек!;ЗАБЕРИТЕ ЭТОТ ЧЕРТОВ ДИСК;ХОНК!;EI NATH;Разъебите станцию!;Устройства для искривления пространства-времени!"
	products = list(
