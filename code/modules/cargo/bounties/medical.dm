/datum/bounty/item/medical/heart
	name = "Сердце"
	description = "Коммандор Джонсон в критическом состоянии после ещё одного пережитого сердечного приступа. Врачи говорят, что им нужно новое сердце как можно быстрее. Отправьте одно, быстро! Мы возьмём и кибернитическое, но только улучшенное."
...
/datum/bounty/item/medical/lung
	name = "Лёгкие"
	description = "Недавний взрыв на Центральном Командовании оставил многих сотрудников с пробитыми лёгкими. Отправьте нам несколько лишних экземпляров. Мы возьмём и кибернитические, но только улучшенные."
...
/datum/bounty/item/medical/liver
	name = "Печень"
	description = "Множество высокопоставленных дипломатов ЦК были госпитализированы с отказом печени после встречи с тремя послами Советского Союза. Помогите нам, ладно? Мы возьмём и кибернетические, если они нам понадобятся, но только если они буду улучшенные."
	reward = CARGO_CRATE_VALUE * 10
	required_count = 3
	wanted_types = list(
...
/datum/bounty/item/medical/surgerycomp
	...
	description = "После очередного взрывного инцидента на нашем ежегодном сырфесте на ЦК, у нас лежит оргромная куча раненного экипажа. Пожалуйста отправьте нам свежий хирургический компьютер, когда это возможно."
...
/datum/bounty/item/medical/surgerytable
	...
	description = "После недавнего притока инфицированного экипажа, мы замечаем, что маски не справляются в одиночку. Серебрянные операционный столы, к слову, могут нам помочь, отправьте нам один для использования."
	reward = CARGO_CRATE_VALUE * 6
