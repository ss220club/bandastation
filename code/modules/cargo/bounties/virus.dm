...
/datum/bounty/virus/New()
	...
	description = "Нанотрейзена заинтересовано в вирусе, имеющем характеристику: [stat_name] с уровнем [stat_value]. Центральное Командование хорошо заплатит за такой вирус."
