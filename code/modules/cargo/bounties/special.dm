...
/datum/bounty/item/trash
	name = "Мусор"
	description = "Недавно, у группы уборщиков кончился мусор для уборки и ЦК решил уволить их для уменьшения расходов. Отправьте мусора, чтобы оставить их на должности, и они дадут вам маленькую компенсацию."
