/datum/bounty/item/engineering/emitter
	name = "Эмиттер"
	description = "Мы предполагаем, что в чертежах эмиттеров на вашей станции может быть дефект, основанный на огромном количестве расслоений, происходящих в вашем секторе. Отправьте нам один из ваших эмиттеров."
...
/datum/bounty/item/engineering/smes_unit
	...
	description = "Нам нужно хранить больше энергии. Отправьте нам СМЭС."
	reward = CARGO_CRATE_VALUE * 6
	wanted_types = list(/obj/machinery/power/smes = TRUE)

/datum/bounty/item/engineering/pacman
	name = "P.A.C.M.A.N. генератор"
	description = "В нашем запасном генератор сгорел предохранитель, нам нужен новый как можно скорее."
	reward = CARGO_CRATE_VALUE * 5
...
/datum/bounty/item/engineering/tesla_coil
	name = "Тесла катушка"
	description = "Наши счета за электричество высоки, отправьте нам теслу катушка для компенсации."
	reward = CARGO_CRATE_VALUE * 5
