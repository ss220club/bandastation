...
/obj/effect/mob_spawn/ghost_role/human/ash_walker
	...
	density = FALSE
	you_are_text = "Ты - ешволкер. Твое племя поклоняется Некрополю."
...
/obj/effect/mob_spawn/ghost_role/human/lavaland_syndicate
	...
	flavour_text = "Увы, ваш главный враг Нанотрейзен начал копать в этом секторе. Постарайтесь продолжать исследования как только можете и не палитесь."
...
/obj/effect/mob_spawn/ghost_role/human/lavaland_syndicate/comms
	...
	flavour_text = "Увы, ваш главный враг, Нанотрейзен, начал копать в этом секторе. Следите за каждым их шагом, и старайтесь не палиться. Используйте экипировку для коммуникации что бы помочь агентам, и суйте дезинформацию что бы сбить Нанотрейзен с толку. Не допустите попадание базы в руки врага!"
...
/obj/effect/mob_spawn/ghost_role/human/lavaland_syndicate/comms/icemoon
	...
	flavour_text = "Увы, ваш главный враг Нанотрейзен начал копать в этом секторе. Следите за каждым их шагом, и старайтесь не палиться. Используйте экипировку для коммуникации что бы помочь агентам, и суйте дизинформацию что бы сбить Нанотрейзен с толку. Не допустите попадание базы в руки врага!"
