...
/datum/round_event/brand_intelligence/announce(fake)
	...
	priority_announce("Сбойный искусственный интеллект торговых автоматов был обнаружен на [station_name()]. Проверьте все торговые автоматы типа [machine_name] на наличие агрессивной маркетинговой тактики и при необходимости перезагрузите их.", "Оповещение о машинном обучении")
