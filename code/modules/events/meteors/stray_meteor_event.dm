...
/datum/round_event/stray_meteor/announce(fake)
	if(GLOB.meteor_list)
		...
		priority_announce("Наши датчики [sensor_name] сенсоры have detected an incoming signature approaching [GLOB.station_name]. Приготовьтесь к столкновению.", "Метеоры")
