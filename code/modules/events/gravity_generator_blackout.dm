...
/datum/round_event/gravity_generator_blackout/announce(fake)
	priority_announce("Гравносферные аномалии обнаружены вблизи [station_name()]. Требуется ручная перезагрузка генераторов гравитации.", "Оповещение об аномалии", ANNOUNCER_GRANOMALIES)
