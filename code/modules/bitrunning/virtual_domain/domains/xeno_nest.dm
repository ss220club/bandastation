/datum/lazy_template/virtual_domain/xeno_nest
	...
	help_text = "Вы находитесь на бесплодной планете, наполненной враждебными существами. Где-то здесь есть неспрятанный ящик, \
	но он хорошо защищен. Ожидайте сопротивления."
	is_modular = TRUE
	key = "xeno_nest"
	map_name = "xeno_nest"
