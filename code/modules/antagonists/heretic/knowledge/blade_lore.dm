...
/datum/heretic_knowledge/ultimate/blade_final
	...
	announcement_text = "%SPOOKY% Мастер клинков, ученик разорванного чемпиона, %NAME% вознесся! Их сталь - это сталь, которая разрежет реальность в вихре серебра! %SPOOKY%"
