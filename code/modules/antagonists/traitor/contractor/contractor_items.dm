...
/obj/item/paper/contractor_guide
	...
	default_raw_text = {"Приветствую вас, агент, поздравляю с новой должностью контрактника. Помимо уже поставленных целей,\
		...
		целей. Три дополнительных предмета которые имелись у нас в наличии были случайно выбраны и выданы вам. Мы надеемся они будут полезны для вашей работы.</p>\
		<p>Магазин контрактора, находится в правом верхнем угле аплинка, он предоставит вам уникальные предметы и возможности. Они могут быть куплены за контракторскую репутацию,\
		...
		<ol>\
			...
			<li>чтобы выполнять контракт вам нужно принести цель до назначенного места высадки, вызвать под отправки и положить\
			цель внутрь пода</li>\
		</ol>\
		<p>Будьте осторожны принимая контракт. Хотя вы сможете видеть местоположение точки высадки, отмена контракта сделает\
