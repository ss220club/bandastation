...
/datum/grand_finale/cheese/trigger(mob/living/invoker)
	...
	priority_announce("Опасность: На станции был вызван чрезвычайно мощный объект, искажающий саму ткань реальности. Рекомендуется немедленная эвакуация. Приготовиться к удару.", "Отдел паранормальных явлений [command_name()]", 'sound/effects/glassbr1.ogg')
