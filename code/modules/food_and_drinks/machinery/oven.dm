...
/obj/machinery/oven/range
	name = "range"
	ru_names = RU_NAMES_LIST_INIT("range", "духовка", "духовки", "духовке", "духовку", "духовкой", "духовке")
...
/obj/item/plate/oven_tray
	name = "oven tray"
	ru_names = RU_NAMES_LIST_INIT("oven tray", "протевень", "протевеня", "протевеню", "протевень", "протевенем", "протевене")
