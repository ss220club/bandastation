...
/obj/item/coffee_cartridge
	...
	ru_names = RU_NAMES_LIST_INIT("coffeemaker cartridge- Caffè Generico", "картридж кофеварки - Caffè Generico", "картриджа кофеварки - Caffè Generico", "картриджу кофеварки - Caffè Generico", "картридж кофеварки - Caffè Generico", "картриджем кофеварки - Caffè Generico", "картридже кофеварки - Caffè Generico")
...
/obj/item/coffee_cartridge/fancy
	...
	ru_names = RU_NAMES_LIST_INIT("coffeemaker cartridge - Caffè Fantasioso", "картридж кофеварки - Caffè Fantasioso", "картриджа кофеварки - Caffè Fantasioso", "картриджу кофеварки - Caffè Fantasioso", "картридж кофеварки - Caffè Fantasioso", "картриджем кофеварки - Caffè Fantasioso", "картридже кофеварки - Caffè Fantasioso")
...
/obj/item/coffee_cartridge/decaf
	...
	ru_names = RU_NAMES_LIST_INIT("coffeemaker cartridge - Caffè Decaffeinato", "картридж кофеварки - Caffè Decaffeinato", "картриджа кофеварки - Caffè Decaffeinato", "картриджу кофеварки - Caffè Decaffeinato", "картридж кофеварки - Caffè Decaffeinato", "картриджем кофеварки - Caffè Decaffeinato", "картридже кофеварки - Caffè Decaffeinato")
...
/obj/item/coffee_cartridge/bootleg
	...
	ru_names = RU_NAMES_LIST_INIT("coffeemaker cartridge - Botany Blend", "картридж кофеварки - Botany Blend", "картриджа кофеварки - Botany Blend", "картриджу кофеварки - Botany Blend", "картридж кофеварки - Botany Blend", "картриджем кофеварки - Botany Blend", "картридже кофеварки - Botany Blend")
...
/obj/item/blank_coffee_cartridge
	...
	ru_names = RU_NAMES_LIST_INIT("blank coffee cartridge", "пустой кофе-картридж", "пустого кофе-картриджа", "пустому кофе-картриджу", "пустой кофе-картридж", "пустым кофе-картриджем", "пустом кофе-картридже")
...
/obj/item/storage/fancy/coffee_cart_rack
	...
	ru_names = RU_NAMES_LIST_INIT("coffeemaker", "стойка для кофе-картриджее", "стойки для кофе-картриджее", "стойке для кофе-картриджее", "стойку для кофе-картриджее", "стойкой для кофе-картриджее", "стойке для кофе-картриджее")
...
/obj/machinery/coffeemaker/impressa
	...
	ru_names = RU_NAMES_LIST_INIT("impressa coffeemaker", "кофемашина Impressa", "кофемашины Impressa", "кофемашине Impressa", "кофемашину Impressa", "кофемашиной Impressa", "кофемашине Impressa")
