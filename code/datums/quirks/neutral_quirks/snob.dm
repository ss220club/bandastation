/datum/quirk/snob
	name = "Snob"
	desc = "Вы заботитесь о тонкостях, и если комната выглядит некрасиво, она того не стоит, не так ли?"
	icon = FA_ICON_USER_TIE
	value = 0
	gain_text = span_notice("Вы ощущаете, что прекрасно понимаете, как должны выглядеть окружение вокруг вас.")
