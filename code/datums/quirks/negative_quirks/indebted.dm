/datum/quirk/indebted
	name = "Indebted"
	desc = "Неудачные жизненные решения, медицинские счета, студенческие кредиты - что бы это ни было, вы наделали немало долгов. Часть всего, что вы получаете, пойдет на его погашение."
	icon = FA_ICON_DOLLAR
