/datum/quirk/claustrophobia
	name = "Claustrophobia"
	desc = "Вы боитесь маленьких и закрытых пространств. Если вы оказываетесь внутри какого-либо контейнера, шкафчика или механизма, у вас начинается приступ паники и вам становится труднее дышать."
