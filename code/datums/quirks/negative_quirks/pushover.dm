/datum/quirk/pushover
	name = "Pushover"
	desc = "Ваш мышление заключается в том, что всегда позволять людям манипулировать вами и делать из вас ведомого. Сопротивление из захвата потребует особых усилий.."
