/datum/quirk/quadruple_amputee
	...
	desc = "Ой! Все протезы! В результате поистине жестокого космического наказания все ваши конечности были заменены на лишние протезы."
...
/datum/quirk/quadruple_amputee/post_add()
	...
	Кроме того, для их устранения необходимо использовать сварочный инструмент и кабели, а не бинты и мази от синяков."))
