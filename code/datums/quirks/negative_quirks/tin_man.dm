/datum/quirk/tin_man
	name = "Tin Man"
	desc = "Ой! Всё в протезах! В результате поистине жестокого космического наказания большинство ваших внутренних органов были заменены на дешевые протезы."
	icon = FA_ICON_USER_GEAR
	value = -6
	medical_record_text = "При физическом осмотре у пациента были обнаружены многочисленные недорогие протезы внутренних органов. \
