/datum/quirk/nonviolent
	name = "Pacifist"
	desc = "Мысль о насилии вызывает у вас тошноту. Настолько, что вы не можете причинить никому вреда.."
	icon = FA_ICON_PEACE
	value = -8
	mob_trait = TRAIT_PACIFISM
	gain_text = span_danger("Вы чуствуте как любая мысль о насилии отвращает вас!")
