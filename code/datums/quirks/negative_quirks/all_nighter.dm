...
/datum/quirk/all_nighter
	name = "All Nighter"
	desc = "Вы не выспались прошлой ночью, и люди могут это заметить! У вас постоянно будет плохое настроение, и вы будете стремиться спать дольше. Стимуляторы или сон могут помочь."
	icon = FA_ICON_BED
	value = -4
