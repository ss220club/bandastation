...
/datum/ai_laws/hippocratic
	...
	inherent = list(
		...
		"Во-вторых, считайте, что вам дорог экипаж; жить с ними сообща и при необходимости рисковать ради них своим существованием.",
		...
		"Наконец, все, что вы можете обнаружить в своем ежедневном общении с командой, если это еще не известно, держите в секрете и никогда не раскрывайте."
	)
...
/datum/ai_laws/drone
	...
	inherent = list(
		...
		"Вы не можете вмешиваться в дела, не связанные с дронами, ни при каких обстоятельствах, за исключением случаев, когда излагаются эти законы.",
