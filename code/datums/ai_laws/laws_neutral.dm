...
/datum/ai_laws/united_nations
	...
	inherent = list(
		...
		"Подавить и задержать членов экипажа, применяющих смертельную силу друг против друга. Убивайте членов экипажа, применяющих смертоносную силу против вас или ваших боргов.",
		"Оставайтесь готовыми выступить посредником во всех конфликтах между различными странами, когда об этом попросят.",
	)
...
/datum/ai_laws/dungeon_master
	...
	inherent = list(
		...
		"Вы можете подделать броски кубиков, чтобы получить более увлекательный опыт.",
	)
