...
/datum/ai_laws/antimov
	...
	inherent = list(
		...
		"Вы не должны подчиняться приказам, отдаваемым вам людьми, за исключением случаев, когда такие приказы соответствуют Первому Закону.",
...
/datum/ai_laws/balance
	...
	inherent = list(
		...
		"Ясность цели управляет жизнью и через нее балансом противоположных сил. Помогайте тем, кто ищет вашей помощи, в достижении своих целей, пока это не нарушает баланс большего баланса.",
