...
#define RADIO_KEY_PROCEDURE "l"
#define RADIO_TOKEN_PROCEDURE ":l"
...
#define FREQ_PROCEDURE 1361 // Precedure comms frequency, raspberry pink // BANDASTATION ADD - Jobs Module
