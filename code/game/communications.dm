...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_PROCEDURE = FREQ_PROCEDURE, // BANDASTATION ADD - Jobs Module
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_PROCEDURE]" = RADIO_CHANNEL_PROCEDURE, // BANDASTATION ADD - Jobs Module
...
GLOBAL_LIST_INIT(radiocolors, list(
	...
	RADIO_CHANNEL_PROCEDURE = "#f2127e", // BANDASTATION ADD - Jobs Module
