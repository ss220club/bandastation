...
/obj/machinery/holopad/proc/activate_holo(mob/living/user)
	...
	if(is_operational)//If the projector has power
		...
		hologram.ru_names_rename(ru_names_list("[user.name] (Hologram)", "голограмма [user.declent_ru(GENITIVE)]", "голограммы [user.declent_ru(GENITIVE)]", "голограмме [user.declent_ru(GENITIVE)]", "голограмму [user.declent_ru(GENITIVE)]", "голограммой [user.declent_ru(GENITIVE)]", "голограмме [user.declent_ru(GENITIVE)]", gender = FEMALE))
...
/obj/machinery/holopad/proc/setup_replay_holo(datum/holorecord/record)
	...
	SET_PLANE_EXPLICIT(hologram, ABOVE_GAME_PLANE, src)
	hologram.set_anchored(TRUE)//So space wind cannot drag it.
	hologram.ru_names_rename(ru_names_list("[record.caller_name] (Hologram)", "голограмма [record.caller_name]", "голограммы [record.caller_name]", "голограмме [record.caller_name]", "голограмму [record.caller_name]", "голограммой [record.caller_name]", "голограмме [record.caller_name]", gender = FEMALE))
...
/obj/machinery/holopad/proc/replay_entry(entry_number)
	...
	switch(command)
		...
		if(HOLORECORD_RENAME)
			replay_holo.ru_names_rename(ru_names_list(entry[2] + " (Hologram)", "голограмма [entry[2]]", "голограммы [entry[2]]", "голограмме [entry[2]]", "голограмму [entry[2]]", "голограммой [entry[2]]", "голограмме [entry[2]]", gender = FEMALE))
