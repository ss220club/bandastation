...
/obj/structure/chair/Initialize(mapload)
	. = ..()
	if(prob(0.2))
		ru_name_rename(RU_NAMES_LIST("tactical chair", "тактический стул", "тактического стула", "тактическому стулу", "тактический стул", "тактическим стулом", "тактическом стуле"))
		name = "tactical [name]"
		fishing_modifier -= 4
	MakeRotate()
