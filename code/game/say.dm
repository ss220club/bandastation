...
/atom/movable/proc/compose_message(atom/movable/speaker, datum/language/message_language, raw_message, radio_freq, list/spans, list/message_mods = list(), visible_name = FALSE)
	...
	return message_order(speaker, spanpart1, spanpart2, freqpart, languageicon, namepart, message_language, raw_message, radio_freq, endspanpart, messagepart) // BANDASTATION EDIT CHANGE: Original - return "[spanpart1][spanpart2][freqpart][languageicon][compose_track_href(speaker, namepart)][namepart][compose_job(speaker, message_language, raw_message, radio_freq)][endspanpart][messagepart]"
