...
/datum/dynamic_ruleset/midround/malf/execute()
	...
	if(prob(MALF_ION_PROB))
		priority_announce("Вблизи станции обнаружен ионный шторм. Пожалуйста, проверьте все оборудование, управляемое ИИ, на наличие ошибок.", "Оповещение об аномалии", ANNOUNCER_IONSTORM)
