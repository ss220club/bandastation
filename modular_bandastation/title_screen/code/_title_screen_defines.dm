...
#define DEFAULT_TITLE_SCREEN_IMAGE 'modular_bandastation/title_screen/icons/title_screen.gif'
#define DEFAULT_TITLE_LOADING_SCREEN 'modular_bandastation/title_screen/icons/loading_screen.gif'
