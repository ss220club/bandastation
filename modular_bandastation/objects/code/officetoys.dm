...
/obj/item/hourglass
	...
	icon = 'modular_bandastation/objects/icons/officetoys.dmi'
...
/obj/item/toy/desk
	...
	var/on = 0
	var/activation_sound = 'modular_bandastation/objects/sound/officetoys/buttonclick.ogg'
...
/datum/looping_sound/fanblow
	start_sound = 'modular_bandastation/objects/sound/officetoys/fan_start.ogg'
	start_length = 40
	mid_sounds = 'modular_bandastation/objects/sound/officetoys/fan_mid1.ogg'
	mid_length = 23
	end_sound = 'modular_bandastation/objects/sound/officetoys/fan_end.ogg'
	volume = 30

/datum/looping_sound/newtonballs
	start_sound = FALSE
	start_length = FALSE
	mid_sounds = 'modular_bandastation/objects/sound/officetoys/newtoncradle_mid1.ogg'
	mid_length = 9
	end_sound = FALSE
	volume = 50
