/datum/quirk/item_quirk/professional_doctor
	...
	lose_text = span_danger("Suddenly, you feel like you lose your knowledge of limbs examinations!")
	medical_record_text = "Patient have a masterfull skills to check conditions of limbs."
