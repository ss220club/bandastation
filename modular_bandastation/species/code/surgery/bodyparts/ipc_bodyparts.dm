/obj/item/bodypart/head/ipc
	icon = 'modular_bandastation/icons/mob/species/ipc/bodyparts.dmi'
	icon_greyscale = 'modular_bandastation/icons/mob/species/ipc/bodyparts.dmi'
	icon_static = 'modular_bandastation/icons/mob/species/ipc/bodyparts.dmi'
