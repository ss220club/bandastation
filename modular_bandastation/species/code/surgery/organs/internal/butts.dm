/obj/item/organ/internal/butt
	...
	worn_icon = 'modular_bandastation/icons/obj/worn_butts.dmi' //Wearable on the head
	icon = 'modular_bandastation/icons/obj/butts.dmi'
	icon_state = "ass"
	...
	var/list/sound_effect  = list('sound/misc/fart1.ogg', 'modular_bandastation/sound/effects/fart2.ogg', 'modular_bandastation/sound/effects/fart3.ogg', 'modular_bandastation/sound/effects/fart4.ogg')
...
/obj/item/organ/internal/butt/skeletal
	...
	sound_effect = list(" modular_bandastation/sound/voice/laugh/skeleton/skeleton_laugh.ogg")
	icon_state =  "skeleass"
...
/obj/item/organ/internal/butt/proc/On_Fart(mob/user)
	...
	for(var/obj/item/storage/book/bible/Holy in Location)
		if(Holy)
			...
			playsound(user,	'modular_bandastation/sound/misc/dagothgod.ogg', 80)
...
/obj/item/organ/internal/butt/attackby(obj/item/I, mob/living/user)
	if(istype(I, /obj/item/bodypart/arm/left/robot) || istype(I, /obj/item/bodypart/arm/right/robot))
		...
		playsound(src, pick('sound/misc/fart1.ogg', 'modular_bandastation/sound/effects/fart2.ogg', 'modular_bandastation/sound/effects/fart3.ogg', 'modular_bandastation/sound/effects/fart4.ogg'), 25 ,use_reverb = TRUE, mixer_channel = CHANNEL_SOUND_EFFECTS)
		qdel(src)
...
/mob/living/simple_animal/bot/buttbot/emag_act(mob/user)
	if(!(bot_cover_flags & BOT_COVER_EMAGGED))
		...
		playsound(src, pick('sound/misc/fart1.ogg', 'modular_bandastation/sound/effects/fart2.ogg', 'modular_bandastation/sound/effects/fart3.ogg', 'modular_bandastation/sound/effects/fart4.ogg'), 100 ,use_reverb = TRUE, mixer_channel = CHANNEL_SOUND_EFFECTS)
