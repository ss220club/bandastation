...
/datum/species/simian/get_laugh_sound(mob/living/carbon/human/human)
	return 'modular_bandastation/sounds/sound/voice/laugh/simian/monkey_laugh_1.ogg'
...
/obj/item/clothing/mask/translator
	...
	icon = 'modular_bandastation/clothing/icons/obj/masks.dmi'
	icon_state = "translator"
	worn_icon = 'modular_bandastation/clothing/icons/mob/mask.dmi'
