...
/datum/species/arachnid/get_scream_sound(mob/living/carbon/human/human)
	return 'modular_bandastation/sounds/sound/voice/screams/arachnid/arachnid_scream.ogg'

/datum/species/arachnid/get_laugh_sound(mob/living/carbon/human/human)
	return 'modular_bandastation/sounds/sound/voice/laugh/arachnid/arachnid_laugh.ogg'
