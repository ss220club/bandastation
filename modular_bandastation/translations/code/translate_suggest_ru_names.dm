...
/mob/proc/_suggested_ru_name(atom/suggested_atom)
	...
	for(var/declent in declents)
		...
		if(!ru_name_suggest[declent])
			...
			return TRUE
	var/message = "suggests RU_NAMES_INIT_LIST(\"[atom_type::name]\", \"[ru_name_suggest[NOMINATIVE]]\", \"[ru_name_suggest[GENITIVE]]\", \"[ru_name_suggest[DATIVE]]\", \"[ru_name_suggest[ACCUSATIVE]]\", \"[ru_name_suggest[INSTRUMENTAL]]\", \"[ru_name_suggest[PREPOSITIONAL]]\")"
