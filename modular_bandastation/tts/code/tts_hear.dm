...
/atom/movable/virtualspeaker/cast_tts(mob/listener, message, atom/location, is_local, is_radio, effect, traits, preSFX, postSFX)
	SEND_SIGNAL(source, COMSIG_ATOM_TTS_CAST, listener, message, location, is_local, is_radio, effect, traits, preSFX, postSFX)
