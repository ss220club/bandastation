...
#define EMOTE_CARBON_SHOESTEAL		"Своровать обувь"
#define EMOTE_CARBON_SIGN 			"Показать число"
#define EMOTE_CARBON_TWIRL 			"Вертеть"
#define EMOTE_CARBON_WAVE 			"Махать рукой"
