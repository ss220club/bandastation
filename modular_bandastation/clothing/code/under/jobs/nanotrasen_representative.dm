/obj/item/clothing/under/rank/nanotrasen_representative
	...
	icon = 'modular_bandastation/clothing/icons/obj/under/nanotrasen_representative.dmi'
	worn_icon = 'modular_bandastation/clothing/icons/mob/clothing/under/nanotrasen_representative.dmi'
