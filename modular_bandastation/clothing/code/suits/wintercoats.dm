/obj/item/clothing/suit/hooded/wintercoat/science/robotics/alt
	...
	icon = 'modular_bandastation/clothing/icons/obj/suits/wintercoat.dmi'
	worn_icon = 'modular_bandastation/clothing/icons/mob/clothing/suits/wintercoat.dmi'
	hoodtype = NONE
...
/obj/item/clothing/head/hooded/winterhood/blueshield
	...
	icon = 'modular_bandastation/clothing/icons/obj/head/winterhood.dmi'
	worn_icon = 'modular_bandastation/clothing/icons/mob/clothing/head/winterhood.dmi'
