/obj/item/clothing/head/helmet/space/plasmaman/blueshield
	...
	icon = 'modular_bandastation/clothing/icons/obj/head/plasmaman_hats.dmi'
	worn_icon = 'modular_bandastation/clothing/icons/mob/clothing/head/plasmaman_head.dmi'
