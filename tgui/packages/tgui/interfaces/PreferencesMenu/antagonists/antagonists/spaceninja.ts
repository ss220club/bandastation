...
const SpaceNinja: Antagonist = {
  ...
  description: [
    multiline`
      ...
      чтобы достичь более совершенного состояния бытия и следовать постмодернистскому космическому бусидо.
    `,
    ...
    multiline`
      ...
      и даже взломайте консоли связи, чтобы вызвать новые угрозы для большего хаоса на станции!
    `,
  ],
