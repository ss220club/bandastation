              ...
              <Stack vertical fill>
                <Stack.Item>
                  ...
                  <span style={destructionstyle}>
                    На странице смертоносности содержатся атакующие заклинания,
                    чтобы уничтожить ваших врагов.
                  </span>
                  <br />
                  ...
                  <span style={transportstyle}>
                    На странице передвижения содержатся заклинания перемещения,
                    очень важный аспект выживания и выполнения поставленных
                    задач.
                  </span>
                  <br />
                  <span style={summonstyle}>
                    На странице вызывания содержатся заклинания призыва и другие
                    полезные заклинания для того, чтобы не сражаться в одиночку.
                    Осторожно, не все призванные вами находятся на вашей
                    стороне.
                  </span>
                  <br />
            ...
            <Section title="Разное снаряжение">
              <Stack>
                <Stack.Item>
                  ...
                  для кастования большинства заклинаний. В вашей книге
