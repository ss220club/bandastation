/obj/machinery/vending/hydroseeds
	...
	product_slogans = "ВОТ ОТКУДА БЕРЕТСЯ ТРАВА! ПУСТИ КОРНИ С НАМИ!;Предоставляем лучший выбор семеян на станции!;Доступны некоторые сорта грибов, больше для специалистов! Получите сертификат уже сегодня!"
